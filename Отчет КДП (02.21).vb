Sub Monthly_Report_02_21()

'Создание нового листа с конечной таблицей за месяц
'TEST
Sheets.Add.Name = "Отчет по трудозатратам за 02.21"

'Добавление столбцов с заголовками в конечной таблицы

Worksheets("Отчет по трудозатратам за 02.21").Activate
...
Selection.Copy
Sheets("Отчет по трудозатратам за 02.21").Select
...
Worksheets("Отчет по трудозатратам за 01.21").Activate
