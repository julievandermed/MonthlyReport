Sub Monthly_Report_11_21()

'Создание нового листа с конечной таблицей за месяц

Sheets.Add.Name = "Отчет по трудозатратам за 11.21"
...
Selection.Copy
Sheets("Отчет по трудозатратам за 11.21").Select
...
Worksheets("Отчет по трудозатратам за 10.21").Activate
