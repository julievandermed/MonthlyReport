Sub Monthly_Report_09_21()

'Создание нового листа с конечной таблицей за месяц

Sheets.Add.Name = "Отчет по трудозатратам за 09.21"

'Добавление столбцов с заголовками в конечной таблицы

Worksheets("Отчет по трудозатратам за 09.21").Activate
...
Selection.Copy
Sheets("Отчет по трудозатратам за 09.21").Select
...
Worksheets("Отчет по трудозатратам за 08.21").Activate
