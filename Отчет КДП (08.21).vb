Sub Monthly_Report_08_21()

'Создание нового листа с конечной таблицей за месяц

Sheets.Add.Name = "Отчет по трудозатратам за 08.21"
...
Selection.Copy
Sheets("Отчет по трудозатратам за 08.21").Select
...
Worksheets("Отчет по трудозатратам за 07.21").Activate
